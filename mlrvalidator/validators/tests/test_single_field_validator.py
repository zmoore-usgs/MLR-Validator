...
class ValidateIsEmptyTestCase(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'agencyCode': {'is_empty': False}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
            'agencyCode': 'USGS'
        }
        self.bad_data = {
...
class ValidateValidSiteNumberTestCase(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'siteNumber': {'valid_site_number': True}}, local_reference_dir='', remote_reference_dir='')
...
class ValidateValidSiteTypeTestCase(TestCase):
    ...
    def setUp(self):
        ...
        with mock.patch('mlrvalidator.validators.reference.open',
            ...
            }, local_reference_dir='ref_dir', remote_reference_dir='ref_dir')
...
class ValidateTypeNumericCheckTestCase(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'altitude': {'type': 'numeric'}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
            'altitude': '1234'
            }
        self.good_data2 = {
...
class ValidateValidPrecisionTestCase(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'altitude': {'valid_precision': True}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
            'altitude': '1234'
            }
        self.good_data2 = {
...
class ValidateTypePositiveNumericTestCase(TestCase):
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'contributingDrainageArea' : {'type': 'positive_numeric'}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
...
class ValidateValidMapScaleCharsTestCase(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'mapScale': {'valid_map_scale_chars': True}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
            'mapScale': '24000'
        }
        self.good_data2 = {
...
class ValidateValidLatitudeDMS(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'latitude': {'valid_latitude_dms': True}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
            'latitude': ' 123456'
        }
        self.good_data2 = {
...
class ValidateValidLongitudeDMSTestCase(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'longitude': {'valid_longitude_dms': True}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
            'longitude': ' 1234556'
        }
        self.good_data2 = {
...
class ValidateValidDateTestCase(TestCase):
    ...
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'firstConstructionDate': {'valid_date': True}}, local_reference_dir='', remote_reference_dir='')
        self.good_data = {
...
class ValidateSingleQuoteTestCase(TestCase):
    def setUp(self):
        self.validator = SingleFieldValidator(schema={'field1': {'valid_single_quotes': True}}, local_reference_dir='', remote_reference_dir='')
